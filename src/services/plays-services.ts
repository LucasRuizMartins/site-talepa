...
export const playsSeason: PlaysDTO[] = [
  {
    name: "Tempus Fugit",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2024-tempus-fugit/bg.jpeg?raw=true",
    year: ["2024"],
    shortDescription:
      "Em Tempus Fugit nós acompanhamos um futuro distópico pós-apocalíptico onde os últimos sobreviventes da humanidade vivem em um labirinto subterrâneo. Acompanhamos a história de Anne e Isac que buscam respostas aos mistérios do labirinto.",
    path: "tempus-fugit",
  },
  {
    name: "Chao Brasil",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2023-chao-brasil/chaobrasil.jpg?raw=true",
    year: ["2023"],
    shortDescription:
  ...
  },
  {
    name: "Bar do Caminho",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2022-bar-do-caminho/bar.jpeg?raw=true",
    year: ["2022"],
    shortDescription:
...

  {
    name: "Insane",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2016-insane/2016-insane.jpg?raw=true",
    year: ["2015", "2016"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2013-as-vozes-de-joana/joana.jpg?raw=true",
    year: ["2013", "2014"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2012-arena-conta-danton/danton.jpg?raw=true",
    year: ["2012"],
    shortDescription:
  ...
  },
  {
    name: "Sussurros",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2011-sussurros/sussurros.jpg?raw=true",
    year: ["2011"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2010-voando-para-o-alto/voando2.JPG?raw=true",
    year: ["2010"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2009-ate-onde-a-vista-alcanca/ate-onde.jpg?raw=true",
    year: ["2009"],
    shortDescription:
  ...
  },
  {
    name: "Motorboy",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2007-motorboy/motorboy.jpg?raw=true",
    year: ["2007"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2006-arena-conta-zumbi/zumbi.jpg?raw=true",
    year: ["2006"],
    shortDescription:
  ...
  },
  {
    name: "O Último Carro",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2005-o-ultimo-carro/ultimo-carro.jpg?raw=true",
    year: ["2005"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2002-o-longo-caminho-ate-a-fonte/longo-caminho.jpg?raw=true",
    year: ["2002"],
    shortDescription:
  ...
  },
  {
    name: "A Pena e A Lei",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2001-a-pena-e-a-lei/a-pena-e-a-lei.jpg?raw=true",
    year: ["2001"],
    shortDescription:
  ...
  },
  {
    ...
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/2000-muito-barulho-por-nada/muito-barulho.jpg?raw=true",
    year: ["2000"],
    shortDescription:
  ...
  },
  {
    name: "Nos Telhados da Cidade",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/1999-nos-telhados-da-cidade/nos-telhados.jpg?raw=true",
    year: ["1999"],
    shortDescription:
      "Musical inspirado em West Side Story e Rooftops, de Robert Wise. Espetáculo que mistura Street Dance e capoeira, permeado pela poesia urbana de Renato Russo. 'Nos telhados da cidade...' narra o cotidiano de um grupo de jovens vivendo em prédios abandonados de São Paulo. Ao enfrentar a violência da cidade grande, eles descobrem o valor da amizade e aprendem a viver um dia de cada vez. Quatro indicações e prêmios de Melhor Coreografia e Melhor Cenografia no XIV Festival de Teatro Estudantil do Estado de São Paulo, 1999.",
    path: "/temporadas/em-construcao",
  },
  {
  ...
  },
  {
    name: "Sing",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/1996-Sing/sing-2.jpg?raw=true",
    year: ["1996"],
    shortDescription:
      "Sing é a competição musical anual entre os veteranos e os calouros de um colégio estadual, e fala dos dramas e perspectivas dos jovens de um bairro decadente. A trilha sonora combina o melhor rock nacional dos anos 80 com samba, tango e new age music. Uma história movimentada, com boa dose de suspense e romantismo, que garantem um final emocionante. Adaptando uma produção cinematográfica norte-americana de 1989, Sing tem duas coreografias originais e outras criadas especialmente para a nossa versão",
    path: "/temporadas/em-construcao",
  },
  {
    name: "Dirty Dancing",
    imgUrl:
      "https://github.com/LucasRuizMartins/midia-arenart/blob/main/temporadas/1994-dirty-dancing/dirty-dancing3.jpg?raw=true",
    year: ["1994"],
    shortDescription:
      "“Senhoras e Senhores! Estamos no verão de 65 e este é o clube Ton & Luc, que reserva muitas surpresas para vocês ! Baby é uma inocente e idealista garota de 16 anos em férias com os pais, num hotel de veraneio. Numa noite, enquanto explora o local, é atraída por uma música para o alojamento dos empregados. Lá conhece Johnny, o instrutor de dança do hotel. Hipnotizada pelas batidas sensuais e os movimentos desinibidos do ritmo quente, Baby logo se torna a aluna preferida de Johnny – tanto na dança quanto no amor. Montagem de palco para o sucesso do cinema, reproduzindo as coreografias originais do filme.",
    path: "/temporadas/em-construcao",
  },
];
